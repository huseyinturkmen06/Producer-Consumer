	...
	public void run()
	{
		...
		do
		{
			...
			if (request.equals("1"))
			{
				...
				output.println("YOU POPED: " + item.takeOne());
				//************

				//item object of Resource class
				//ensures consuming of item şn Resource class by using takeOne() method
			}
		}
